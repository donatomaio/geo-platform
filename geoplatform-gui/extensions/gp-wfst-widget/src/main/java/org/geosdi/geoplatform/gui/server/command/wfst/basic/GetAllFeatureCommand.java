...
public class GetAllFeatureCommand implements GPCommand<GetAllFeatureRequest, GetAllFeatureResponse> {

    private static final Logger logger = LoggerFactory.getLogger(GetAllFeatureCommand.class);
    //
    @Autowired
